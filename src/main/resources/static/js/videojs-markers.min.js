...
!function (e, r) {
    if ("function" == typeof define && define.amd) define(["video.js"], r); else if ("undefined" != typeof exports) r(require("video.js")); else
    {
        r(e.videojs), e.videojsMarkers = {}
    }
}(this, function (e) {
    "use strict";
    var r, h = (r = e) && r.__esModule ? r : {default: r};
    var x = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        return typeof e
    } : function (e) {
        return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
    }, b = {
        markerStyle: {width: "7px", "border-radius": "30%", "background-color": "red"}, 
        markerTip: {
            display: !0, text: function (e) {
                return  e.text
            }, time: function (e) {
                return e.time
            }
        }, breakOverlay: {
            display: !1, displayTime: 3, text: function (e) {
                return "Break overlay: " + e.overlayText
            }, style: {width: "100%", height: "20%", "background-color": "rgba(0,0,0,0.7)", color: "white", "font-size": "17px"}
    ...
    function T(e)
    {
        var r, t = {top: 0, bottom: 0, left: 0, width: 0, height: 0, right: 0};
        try
        {
    ...
    var g = -1;
    h.default.registerPlugin("markers", function (n) {
        if (!h.default.mergeOptions)
        {
            var o = function (e) {
                return !!e && "object" === (void 0 === e ? "undefined" : x(e)) && "[object Object]" === toString.call(e) && e.constructor === Object
            };
            h.default.mergeOptions = function i(e, r) {
                var a = {};
        ...
        h.default.dom.createEl || (h.default.dom.createEl = function (e, r, t) {
            var i = h.default.Player.prototype.dom.createEl(e, r);
            return t && Object.keys(t).forEach(function (e) {
                i.setAttribute(e, t[e])
            }), i
        });
        var l = h.default.mergeOptions(b, n), u = {}, d = [], c = g, s = this, f = null, a = null, m = g;
        ...
        function t(e)
        {
            e.forEach(function (e) {
                ...
                })), s.el().querySelector(".vjs-progress-holder").appendChild((i = e, r = h.default.dom.createEl("div", {}, {
        ...
        function y(e, r)
        {
            r.className = "vjs-marker" + (e.classText || ""), Object.keys(l.markerStyle).forEach(function (e) {
                r.style[e] = l.markerStyle[e]
            });
            var t = e.time / s.duration();
            var tstart = e.start / s.duration();
            var tend = e.end / s.duration();
            if ((t < 0 || 1 < t) && (r.style.display = "none"), r.style.left = v(e) + "%", e.duration)
            	r.style.width = e.duration / s.duration() * 100 + "%", r.style.marginLeft = "0px"; 
            else
            {
                var i = T(r);
        ...
        function e()
        {
            ...
            {
                var e = s.currentTime(), r = d[c], t = l.markerTip.time(r);
        ...
        function k()
        {
            !function () {
                if (d.length)
                {
                    ...
                    if (r < l.markerTip.time(d[0])) t = g; else for (var a = 0; a < d.length; a++) if (i = e(a), r >= l.markerTip.time(d[a]) && r < i)
                    {
                        t = a;
                        break
                    }
        ...
        function p()
        {
            l.markerTip.display && (f = h.default.dom.createEl("div", {
                className: "vjs-tip",
                innerHTML: "<div class='vjs-tip-arrow'></div><div class='vjs-tip-inner'></div>"
            }), s.el().querySelector(".vjs-progress-holder").appendChild(f)), s.markers.removeAll(), t(l.markers), l.breakOverlay.display && (a = h.default.dom.createEl("div", {
        ...
        s.on("loadedmetadata", function () {
            ...
            getMarkers: function () {
                ...
                i = e, d.forEach(function (e) {
                    var r = s.el().querySelector(".vjs-marker[data-marker-key='" + e.key + "']"), t = l.markerTip.time(e);
